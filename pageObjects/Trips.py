...
class Trips:
    ...
    button_select_startdate_xpath = "//button[normalize-space()='22']"
    ...
    dropdown_source_click_state = "//div[normalize-space()='Florida']//div[@id='demo-simple-select']"
    dropdown_source_select_state = "//li[normalize-space()='Texas']"
    dropdown_source_click_city = "(//div[@id='demo-simple-select'])[2]"
    dropdown_source_select_city = "//li[normalize-space()='Waco']"
    dropdown_dest_click_state = "//div[normalize-space()='Arizona']//div[@id='demo-simple-select']"
    dropdown_dest_select_state = "//li[normalize-space()='Indiana']"
    dropdown_dest_click_city = "(//div[@id='demo-simple-select'])[4]"
    dropdown_dest_select_city = "//li[normalize-space()='Gary']"
    dropdown_click_assignDriver_xpath = "//div[@class='text-feild flex flex--justify-start']//button[@title='Open']//*[name()='svg']"
    dropdown_select_assignDriver_xpath = "//li[@id='driver-names-option-10']"
